...
import io.u2ware.ocpp.v2_0_1.handlers.Heartbeat; // 2.
import io.u2ware.ocpp.v2_0_1.handlers.TransactionEvent; // 2.
import io.u2ware.ocpp.v2_0_1.messaging.ChargingStationCommand;
import io.u2ware.ocpp.v2_0_1.messaging.ChargingStationCommandOperations; // 4.
...
public class MyCustomHandler implements      
    ...
    protected @Autowired(required = false) ChargingStationCommandOperations operations;
